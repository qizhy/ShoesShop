        ...
        <div className='shoes-detail col-lg-12'>
            ...
            <div className='info col-lg-6'>
                ...
                <div className='col-lg-12 buttons'>
                    ...
                    {(currentProduct != null && quantity > 0) ? 
                        <Link className='link' style={{color : 'white'}} 
                        to={`/payment/product-id/${product.id}/${currentProduct.color}/${currentProduct.size}/${currentProduct.price}/${quantity}`}>
                        <button className='btn-buy'>Buy Now</button></Link> :
            ...
            <ListShoe products={products} current_product_id={product.id}/>
        </div>
    );
}
